...
export default function ProjectList() {
  return (
    <Layout>
      ...
      <div className={style.projectsarea}>
        <Project
          repo="https://github.com/coderbaozi/baozi-Navigation"
          name="Navigation"
          icon="search"
      ...
      <div className={style.projectsarea}>
        <Project
          repo="https://github.com/coderbaozi/vue-question"
          name="vue-question"
          icon="question"
          description="Project issue gathered some Front End konwledge"
        ></Project>
      </div>
    </Layout>
  );
